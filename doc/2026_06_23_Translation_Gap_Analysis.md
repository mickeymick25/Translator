...
- Source (nouvelle) : `translator/output/2026_06_12_Export` vs source EN courante
...
## Clés à ajouter (communes à toutes les langues : 10)
...
## Clés à modifier — source modifiée entre ancienne et nouvelle source (communes : 0)
...
1. **Ajouter** 10 nouvelle(s) clé(s) × 6 langue(s) = 60 traductions à produire.
2. **Supprimer** 0 clé(s) orpheline(s) des fichiers cibles (commun à toutes les langues).
3. **Modifier** 0 clé(s) dont la source a changé (retraduire).
