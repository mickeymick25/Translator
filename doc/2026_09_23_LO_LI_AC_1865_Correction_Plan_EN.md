...
| 2026-09-23 | — | 🧹 **History purge** (Michael's decision, option B): 2 `git filter-repo` passes (Docker, python:3.11-slim) — pass 1: `Export_COP_MessageExcel.numbers` (17/06 leak) + `translation_en_fr.json.bak`; pass 2: recette artifacts under output (official TSV mapping + checklist + recette) + `doc/2026_06_26_FR_Misalignment_History.csv` — output empty of content across the whole history; pre-purge backup: `translator_backup_20260923.bundle` (project root). Final remap: bf38039→334dc5e · 1d7237d→d9c8efa · 9244a20→b25720b · 2571ece→e2784ab · 7f41a4c→3c78ae2 · 8fefea9→**commit removed (pruned by purge)** · f40f4ae→c197d11 · b61f0aa→d5f7feb · 1614272→0824554 · c8ef638→075310c · 393bb87→ee9ba8a · 27f116c→7c474ee · f3d507e→34c6b54 · cf49e5e→d461346 — then **force-push required** | Agent |
